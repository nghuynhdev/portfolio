...
export default function Navigation() {
  ...
  return (
    <motion.nav 
      className="fixed top-0 left-0 right-0 bg-white/80 dark:bg-[#0b0e18]/95 backdrop-blur-xl z-50 border-b border-black/[0.08] dark:border-white/[0.06] shadow-sm dark:shadow-none"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
